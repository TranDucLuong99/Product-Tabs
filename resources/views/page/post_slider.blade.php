...
<head>
    ...
    <link rel="apple-touch-icon-precomposed" sizes="144x144"
          href="OwlCarousel2-2.3.4/docs/assets/ico/apple-touch-icon-144-precomposed.png">
    <link rel="shortcut icon" href="OwlCarousel2-2.3.4/docs/assets/ico/favicon.png">
...
<div class="owl-carousel owl-theme">
    @foreach($posts as $post)
        <div class="row1">
            <div class="title"><a href="https://dth99store.myshopify.com/apps/blogtest/post-all/detail/{{$post->id}}"><h4>{{$post->name}}</h4></a></div>
